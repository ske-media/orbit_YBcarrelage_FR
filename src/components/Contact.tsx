import React from 'react'; import { Phone, MapPin, Clock } from 'lucide-react';

const Contact = () => { return ( <section id="contact" className="relative py-20 bg-gradient-to-br from-white via-white to-khaki/10 overflow-hidden">
            ...
            <div className="ml-4">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <a href="tel:+41765480001" className="block text-custom-gray hover:text-premium-base transition-colors">
                    +41 76 548 00 01
                  </a>
                </div>
                <div>
                  <span className="text-sm text-custom-gray">France :</span>
                  <a href="tel:+33770151468" className="block text-custom-gray hover:text-premium-base transition-colors">
                    +33 7 70 15 14 68
                  </a>
                </div>
              </div>
